...
(function ($, window, document, undefined) {
    ...
    function Plugin(el, options) {
        ...
        this.elementCount = 0;
        // costum code added to adapt this library with my form
        this.addLink = $('<a>').addClass('btn btn-success add').html('<i class="fa fa-plus"></i><span class="sr-only">' + this.options.i18n.addText + '</span>');
        this.removeLink = $('<a>').addClass('btn btn-danger remove').html('<i class="fa fa-minus"></i><span class="sr-only">' + this.options.i18n.removeText + '</span>');
    ...
    Plugin.prototype = {
        ...
        createElement: function (el, suffix, data) {
            ...
            var add = _this.addLink.clone(false).click(function (e) {
                ...
                if (_this.elementCount < _this.options.limit) {
                    ...
                    if(typeof swal == 'undefined'){
                        ...
                        swal({
                            title: _this.options.i18n.limitMessage,
                            text: "Vous ne pouvez pas inserer plus de 7 jour.",
                            icon: "warning"
                        });
                    }
                }
            ...
            // costum code added to adapt this library with my form
            cloneWrap.children('.formdic').children('.form-group').children('.btn-control').append(add).append(remove);
