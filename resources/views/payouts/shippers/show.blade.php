...
@section('title_header', 'Tableau de bord - Expéditeur : '.$user->full_name)
@section('sub_title_header', 'Suivi des transactions et état des comptes')


@section('breadcrumbs')
    @if (Auth::user()->isSuperAdmin())
        {{ Breadcrumbs::render('shippers_payouts.wallet') }}
    @else
...
<div class="col-lg-6 col-xs-6">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <a href="#" class="small-box-foote in-dev-infor">Plus d'info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-lg-3 col-xs-6">
        <!-- small box -->
            ...
            <div style="padding: 1rem 2rem">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Transaction recente</strong></h3>
                    </div>
                        <!-- /.box-header -->
                        <div class="box-body">
