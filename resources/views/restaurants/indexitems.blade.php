...
@section('breadcrumbs')
    {{ Breadcrumbs::render('restaurants.items') }}
@stop
...
@section('main')
    ...
    <p class="text-left">
        <a href="{{ route('items.create', isset($restaurant) ? $restaurant->id : '') }}" class="btn btn-primary"
            title="Ajouter un article"><i class="fa fa-fw fa-plus-circle"></i> Ajouter</a>
    </p>
    <div class="box">
        <div class="box-header">
        <h3 class="box-title">Tous les articles du {{ $restaurant->type }} : <a href="{{ route('restaurants.show', $restaurant) }}">{{ $restaurant->name }}</a></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
